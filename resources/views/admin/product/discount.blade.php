 ...
 <div class="card shadow mb-4">
    <div class="card-header py-3">
      ...
      <div class="d-flex float-right">
        <form style="width: 28rem; display : flex; justify-content : center ; align-items : center;" method="post" action="{{route('discount.pdf')}}"  >
          {{csrf_field()}}
            ...
            @foreach($books as $product)
              ...
              @endphp --}}
                <tr>
                    ...
                    <td>Rp. {{number_format($product->price-(($product->discount * $product->price)/100))}}</td>
                    ...
                    <td>
                      ...
                      <a href="{{route('edit-discount', $product->id)}}" class="btn btn-warning btn-sm btn-round btn-just-icon">
