        ...
        <div class="col-md-12">
          <form method="post" action="{{route('user.update', $user->id)}}"  >
            ...
            <div>
              ...
              <input id="name" type="text" name="name" placeholder="Masukan Nama"  value="{{$user->name}}" class="form-control">
              @error('name')
            ...
            <div>
                ...
                <input id="email" type="text" name="email" placeholder="Masukan Email"  value="{{$user->email}}" class="form-control">
                @error('email')
                <span class="text-danger">{{$message}}</span>
                @enderror
            </div>
            ...
            {{-- <div>
                ...
                <input id="password" type="password" name="password" placeholder="Masukan Password"  value="{{$user->password}}}" class="form-control">
                @error('password')
                    <span class="text-danger">{{$message}}</span>
                @enderror
            </div> --}}
            ...
            <div style="margin-top : 20px;">
              ...
              <select name="role" class="form-control">
                  ...
                  <option {{(($user->role=='su') ? 'selected' : '')}} value='su'>Super User</option>
              </select>
              @error('role')
              <span class="text-danger">{{$message}}</span>
              @enderror
