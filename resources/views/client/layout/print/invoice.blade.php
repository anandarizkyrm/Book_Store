...
<style type="text/css">
  ...
  <div class="invoice-header">
    ...
    <div class="float-right site-address">
      ...
      <p>Jl. Pesanggrahan Banjarmasin Kalimantan Selatan no 89</p>
      <p>Phone: <a href="tel:{{env('APP_PHONE')}}">08391283-128312</a></p>
  ...
  <section class="order_details pt-3">
    ...
    <table class="table table-bordered table-stripe">
      ...
      @php 
        $product=DB::table('books')->select('name')->where('id',$cart->book_id)->get();
      @endphp
        <tr>
          <td><span>
