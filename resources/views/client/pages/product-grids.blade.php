                    ...
                    <div class="col-lg-9 col-md-8 col-12">
                                    ...
                                    <div class="shop-shorter">
                                        ...
                                        <div class="single-shorter">
                                            ...
                                            <select class='sortBy' name='sortBy' onchange="this.form.submit();">
                                                ...
                                                <option value="publisher" @if(!empty($_GET['sortBy']) && $_GET['sortBy']=='publisher') selected @endif>Brand</option>
                                            </select>
                                        </div>
                                    </div>
                                    <ul class="view-mode">
                        ...
                        <div class="row">
                            ...
                            @if(count($products)>0)
                                ...
                                @endforeach
                            @else
                                    <h4  style="margin:100px auto;">There are no products.</h4>
                            @endif
                                            ...
                                            <div class="quickview-ratting-review">
                                                <div class="quickview-ratting-wrap">
                                                    <div class="quickview-ratting">
                                                        ...
                                                        @php
                                                            $rate=DB::table('review')->where('book_id',$product->id)->avg('rating');
                                                            $rate_count=DB::table('review')->where('book_id',$product->id)->count();
                                                        @endphp
                                                        @for($i=1; $i<=5; $i++)
                                                            @if($rate>=$i)
                                                                <i class="yellow fa fa-star"></i>
