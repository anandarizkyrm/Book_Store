...
class Order extends Model
{
    ...
    protected $fillable = [ 'order_number', 'sub_total', 'total_amount', 'quantity', 'payment_method', 'payment_status', 'status', 'user_id', 'shipping_id', 'email', 'phone', 'address', 'post_code'];
